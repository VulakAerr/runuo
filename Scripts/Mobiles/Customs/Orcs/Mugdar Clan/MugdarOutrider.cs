...
namespace Server.Mobiles
{
	...
	public class MugdarOutrider : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public MugdarOutrider() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.01, 0.005 )
		{
		...
		public MugdarOutrider( Serial serial ) : base( serial )
		{
		}
