...
namespace Server.Mobiles
{
	...
	public class MugdarArcherOutrider : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public MugdarArcherOutrider() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.01, 0.005 )
		{
			Name = NameList.RandomName( "orc" );
			Body = 0x190;
			BaseSoundID = 0x45A;
			Title = "the Mugdar Clan Outrider";
		...
		public MugdarArcherOutrider( Serial serial ) : base( serial )
		{
		}
