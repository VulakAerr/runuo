...
namespace Server.Mobiles
{
	...
	public class MugdarChef : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public MugdarChef() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Sabu";
			Body = 1;
			BaseSoundID = 0x45A;
			Title = "the Mugdar Tribe Chef";
		...
		public MugdarChef( Serial serial ) : base( serial )
		{
		}
